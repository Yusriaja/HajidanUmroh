...
//                    Sub menu Umroh
                    ...
                    subMenuContents.add(new SubMenuContent(idSubMenu,1,  "Rukun Umrah"));
                        ...
                        detailContents.add(new DetailContent(idDetailContent, "2.\tThawaf", idSubMenu));
                        ...
                        detailContents.add(new DetailContent(idDetailContent, "3.\tSai", idSubMenu));
                        ...
                        detailContents.add(new DetailContent(idDetailContent, "4.\tCukur", idSubMenu));
                        ...
                        detailContents.add(new DetailContent(idDetailContent, "5.\tTertib", idSubMenu++));
                    ...
                    subMenuContents.add(new SubMenuContent(idSubMenu,1,  "Larangan Selama Ihram Sampai Tahallul / Cukur"));
                        detailContents.add(new DetailContent(idDetailContent++, "1.\tLarangan Khusus Laki-laki", idSubMenu));
                        detailContents.add(new DetailContent(idDetailContent++, "2.\t Khusus Perempuan", idSubMenu));
                        detailContents.add(new DetailContent(idDetailContent++, "3.\tLarangan Umum Bagi Laki-laki dan Perempuan.", idSubMenu++));
...
//                    Sub menu Haji
                    ...
                    detailContents.add(new DetailContent(idDetailContent++, "1.\tIhram (Rukun Haji)", idSubMenu));
                    detailContents.add(new DetailContent(idDetailContent++, "2.\tNiat Ihram dari Miqot (Wajib Haji)", idSubMenu));
                    detailContents.add(new DetailContent(idDetailContent++, "3.\tWukuf di Arafah (Rukun Haji)", idSubMenu));
                    detailContents.add(new DetailContent(idDetailContent++, "4.\tMabit di Muzdalifah (Wajib Haji)", idSubMenu));
                    detailContents.add(new DetailContent(idDetailContent++, "5.\tMabit di Mina (Wajib Haji)", idSubMenu));
                    detailContents.add(new DetailContent(idDetailContent++, "6.\tMelontar Jumrah Ula, Wustho dan Aqobah (Wajib Haji)", idSubMenu));
                    detailContents.add(new DetailContent(idDetailContent++, "7.\tThawaf Ifadlah (Rukun Haji)", idSubMenu));
                    detailContents.add(new DetailContent(idDetailContent++, "8.\tSai (Rukun Haji)", idSubMenu));
                    detailContents.add(new DetailContent(idDetailContent++, "9.\tCukur (Rukun Haji)", idSubMenu));
                    detailContents.add(new DetailContent(idDetailContent++, "10.\tThawaf Wada (Wajib Haji)", idSubMenu++));

//                    ==============================================================================================================================
//                    Sub menu dam
                    subMenuContents.add(new SubMenuContent(idSubMenu, 5, "Pengertian"));
                        detailContents.add(new DetailContent(idDetailContent++, "Dam dalam pengertian bahasa adalah darah, sedangkan menurut istilah adalah mengalirkan darah (menyembelih) hewan ternak, yaitu kambing, sapi, unta di tanah haram, atau melakukan puasa atau memberikan makanan kepada orang-orang miskin dalam rangka memenuhi ketentuan manasik Haji.", idSubMenu++));

                    subMenuContents.add(new SubMenuContent(idSubMenu, 5, "Macam - Macam Dam"));
                        detailContents.add(new DetailContent(idDetailContent++, "1.\tDam Nusuk ", idSubMenu));
                        detailContents.add(new DetailContent(idDetailContent++, "2.\tDam Isaah ", idSubMenu++));

                    subMenuContents.add(new SubMenuContent(idSubMenu, 5, "Ketentuan - Ketentuan Dam"));
                        detailContents.add(new DetailContent(idDetailContent++, "1.\tHukumnya wajib7", idSubMenu));
                        detailContents.add(new DetailContent(idDetailContent++, "2.\tDapat berupa hewan, puasa, atau memberikan makanan kepada orang miskin, sesuai dengan pelanggaran yang dilakukan.", idSubMenu));
                        detailContents.add(new DetailContent(idDetailContent++, "3.\tJika dam berupa hewan maka harus disembelih di tanah haram Makkah, tidak boleh di tempat lain, ", idSubMenu));
                        detailContents.add(new DetailContent(idDetailContent++, "4.\tSunnah disembelih pada hari raya Idul Adlha, namun jika berhalangan maka boleh disembelih di hari-hari yang lain.", idSubMenu));
                        detailContents.add(new DetailContent(idDetailContent++, "5.\tOrang yang membayar dam hewan tidak boleh sama sekali memakan dagingnya, wajib disedekahkan semuanya kepada orang miskin. ", idSubMenu));
                        detailContents.add(new DetailContent(idDetailContent++, "6.\tTidak boleh dihadiahkan kepada orang kaya.", idSubMenu++));

//                    =================================================================================================================================
//                    Sub menu sholat
                    subMenuContents.add(new SubMenuContent(idSubMenu, 3, "Shalat Sunnah Lis-Safar"));
                        detailContents.add(new DetailContent(idDetailContent, "Detail", idSubMenu++));
